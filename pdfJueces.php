...
<tr style="background-color:#2d8673;color:#FFFFFF; border-color: #FFFFFF;">
 ...
 <td width="40" align="center"><b>2</b></td>
  <td width="148" >Materia Penal Acusatoria</td>
...
<td width="40" align="center"><b>5</b></td>
 ...
 <table  cellpadding="1" cellspacing="1">
  <tr>
   <td width="136"  align="center" >'.$datosFormulario["capacitacion_j3_2_int"] .'</td>
  </tr>
 </table>
 ...
 <table  cellpadding="1" cellspacing="1">
  <tr>
   <td width="136"  align="center" >'.$datosFormulario["presupuesto_j4_1_pre"] .'</td>
  </tr>
 </table>
 ...
 <table  cellpadding="1" cellspacing="1">
  <tr>
   <td width="136"  align="center" >'.$datosFormulario["presupuesto_j4_2_preserv"] .'</td>
  </tr>
 </table>
...
5.- ¿Con qué protocolos cuenta la institución para garantizar los derechos de las mujeres?
 ...
 <td width="528">Cuáles: '.$datosFormulario["mujeres_j5_proint_cuales"] .'</td>
   </tr>
   <tr>
  <td width="128">'.$datosFormulario["mujeres_j5_prointr"] .'</td>
  <td width="528">Cuáles: '.$datosFormulario["mujeres_j5_prointr_cuales"] .'</td>
  </tr>
  <tr>
  ...
  <td width="528">Cuáles: '.$datosFormulario["mujeres_j5_otros_cuales"].'</td>
  </tr>
  <tr>
...
<table  cellpadding="1" cellspacing="1">
 ...
 <table  cellpadding="1" cellspacing="1">
  <tr>
   <td width="136"  align="center" >'.$datosFormulario["mujeres_j5_2_cuabuepra"] .'</td>
  </tr>
 </table>
...
6.- ¿Con qué protocolos cuenta la institución para garantizar los derechos de niñas, niños y adolescentes?
 ...
 <td width="528">Cuáles: '.$datosFormulario["ja_j6_proint_cual"] .'</td>
   </tr>
   <tr>
  <td width="128">'.$datosFormulario["ja_j6_prointr"] .'</td>
  <td width="528">Cuáles: '.$datosFormulario["ja_j6_prointr_cual"] .'</td>
  </tr>
  <tr>
  ...
  <td width="528">Cuáles: '.$datosFormulario["ja_j6_otros_cual"].'</td>
  </tr>
  <tr>
  ...
  <table  cellpadding="1" cellspacing="1">
   ...
   <table  cellpadding="1" cellspacing="1">
    <tr>
     <td width="136"  align="center" >'.$datosFormulario["ja_j6_2_cuabuepra"] .'</td>
    </tr>
   </table>
    ...
    <table  cellpadding="1" cellspacing="1">
     ...
     <table  cellpadding="1" cellspacing="1">
      ...
      <table  cellpadding="1" cellspacing="1">
       ...
       <table  cellpadding="1" cellspacing="1">
        <tr>
         <td width="136"  align="center" >'.$datosFormulario["indigenas_j7_3_nomins"] .'</td>
        </tr>
        <tr>
        ...
        7.4.- ¿Con qué protocolos cuenta la institución para garantizar los derechos de las personas indígenas?
         ...
         <td width="528">Cuáles: '.$datosFormulario["indigenas_j7_4_proint_cual"] .'</td>
           </tr>
           <tr>
          <td width="128">'.$datosFormulario["indigenas_j7_4_prointr"] .'</td>
          <td width="528">Cuáles: '.$datosFormulario["indigenas_j7_4_prointr_cual"] .'</td>
          </tr>
          <tr>
          ...
          <td width="528">Cuáles: '.$datosFormulario["indigenas_j7_4_otro_cual"].'</td>
          </tr>
          <tr>
          ...
          <table  cellpadding="1" cellspacing="1">
           ...
           <table  cellpadding="1" cellspacing="1">
            <tr>
             <td width="136"  align="center" >'.$datosFormulario["indigenas_j7_6_cuabuepra"] .'</td>
            </tr>
            </table>
...
<table  cellpadding="1" cellspacing="1">
 <tr>
  <td width="136"  align="center" >'.$datosFormulario["extranjeras_j8_3_nomins"] .'</td>
 </tr>
 <tr>
...
8.4.- ¿Con qué protocolos cuenta la institución para garantizar los derechos de personas extranjeras?
  ...
  <td width="528">Cuáles: '.$datosFormulario["extranjeras_j8_4_proint_cual"] .'</td>
  </tr>
  <tr>
  <td width="128">'.$datosFormulario["extranjeras_j8_4_prointr"] .'</td>
  <td width="528">Cuáles: '.$datosFormulario["extranjeras_j8_4_prointr_cual"] .'</td>
  </tr>
  <tr>
  ...
  <td width="528">Cuáles: '.$datosFormulario["extranjeras_j8_4_otro_cual"].'</td>
  </tr>
  <tr>
...
<table  cellpadding="1" cellspacing="1">
 <tr>
  <td width="136"  align="center" >'.$datosFormulario["extranjeras_j8_6_cuabuepra"] .'</td>
 </tr>
 <tr>
...
9.- ¿La institución tiene convenios con otras instituciones u organizaciones de la sociedad civil que les proporcionen alguno de estos servicios para personas con discapacidad?
  ...
  <table  cellpadding="1" cellspacing="1">
   <tr>
    <td width="136"  align="center" >'.$datosFormulario["discapacidad_j9_1_nomins"] .'</td>
   </tr>
   <tr>
  ...
  9.2.- ¿Con qué protocolos cuenta la institución para garantizar los derechos de personas con discapacidad?
    ...
    <td width="528">Cuáles: '.$datosFormulario["discapacidad_j9_2_proint_cual"] .'</td>
    </tr>
    <tr>
    <td width="128">'.$datosFormulario["discapacidad_j9_2_prointr"] .'</td>
    <td width="528">Cuáles: '.$datosFormulario["discapacidad_j9_2_prointr_cual"] .'</td>
    </tr>
    <tr>
    ...
    <td width="528">Cuáles: '.$datosFormulario["discapacidad_j9_2_otros_cual"].'</td>
    </tr>
    <tr>
  ...
  <table  cellpadding="1" cellspacing="1">
   <tr>
    <td width="136"  align="center" >'.$datosFormulario["discapacidad_j9_4_cuabuepra"] .'</td>
   </tr>
   <tr>
...
<table>
  ...
  <table  cellpadding="1" cellspacing="1">
   <tr>
    <td width="136"  align="center" >'.$datosFormulario["colaboracion_j10_1_ins"] .'</td>
   </tr>
   <tr>
  ...
  <table  cellpadding="1" cellspacing="1">
   <tr>
    <td width="136"  align="center" >'.$datosFormulario["colaboracion_j10_3_tipcol"] .'</td>
   </tr>
   <tr>
  ...
  <table>
    ...
    <table  cellpadding="1" cellspacing="1">
     <tr>
      <td width="136"  align="center" >'.$datosFormulario["registro_j11_1_ser"] .'</td>
     </tr>
    </table>
    ...
    <table  cellpadding="1" cellspacing="1">
     <tr>
      <td width="136"  align="center" >'.$datosFormulario["registro_j11_2_lig"] .'</td>
     </tr>
    </table>
    ...
    <table>
      ...
      <table  cellpadding="1" cellspacing="1">
       <tr>
        <td width="136"  align="center" >'.$datosFormulario["evaluacion_j12_1_cuaind"] .'</td>
       </tr>
      </table>
      ...
      <table  cellpadding="1" cellspacing="1">
       <tr>
        <td width="136"  align="center" >'.$datosFormulario["evaluacion_j12_2_frec"] .'</td>
       </tr>
      </table>
...
13.- ¿Las sentencias emitidas por el poder judicial son públicas?
  ...
  <table  cellpadding="1" cellspacing="1">
   <tr>
    <td width="136"  align="center" >'.$datosFormulario["transparencia_j13_sen"] .'</td>
   </tr>
</table>
<table>
<tr>
...
<table  cellpadding="1" cellspacing="1">
 <tr>
  <td width="136"  align="center" >'.$datosFormulario["transparencia_j13_4_bueprac_cuales"] .'</td>
 </tr>
 <tr>
 ...
 <td width="40" align="center"><b>5</b></td>
  ...
  <td width="40" align="center"><b>5</b></td>
   ...
   <td width="40" align="center"><b>5</b></td>
    ...
    <table  cellpadding="1" cellspacing="1">
     <tr>
      <td width="136"  align="center" >'.$datosFormulario["victimas_j23_3_cuabuepra"] .'</td>
     </tr>
    </table>
<!-- Fin Tab 7-->
...
<table>
  ...
  <tr>
  <td width="528"><b>
  24.2.- ¿Qué instituciones participan en las Mesas de Justicia -judicialización-?
  </b>
  </td>
    </tr>
    <tr>
  ...
  <table  cellpadding="1" cellspacing="1">
   <tr>
    <td width="136"  align="center" >'.$datosFormulario["justicia_j24_3_buepra"] .'</td>
   </tr>
  </table>
  ...
  <table>
    ...
    <table  cellpadding="1" cellspacing="1">
     <tr>
      <td width="136"  align="center" >'.$datosFormulario["impacto_j25_1_desc"] .'</td>
     </tr>
    </table>
    ...
    <tr>
    <td><p style="font-size: 12px;"><b>
    25.3.- Describir las medidas señaladas en la pregunta anterior.
    </b></p>
    </td>
      </tr>
    </table>
    <table  cellpadding="1" cellspacing="1">
     <tr>
      <td width="136"  align="center" >'.$datosFormulario["impacto_j25_3_desc"] .'</td>
     </tr>
    </table>
    ...
    <table>
      ...
      <tr>
      <td><b>
      26.6.- Total de personas imputadas que fueron remitidas a algún programa de atención y/o tratamiento específico para atender el consumo problemático de sustancias psicoactivas. Desglosar por sexo y soluciones alternas.
      </b>
      </td>
        </tr>
      </table>
